...
/* Стиль для карточек при перетаскивании */
.task__item:active {
    cursor: grabbing;
    opacity: 0.8;
}
...
.task__item.hidden {
  ...
  /* Эффект при наведении на список */
  .task__list {
    min-height: 50px;
...
`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,UAAU;IACV,SAAS;AACb;;AAEA;IACI,yBAAyB;IACzB,YAAY;IACZ,UAAU;AACd;;AAEA,gBAAgB;AAChB;IACI,8BAA8B;IAC9B,yBAAyB;IACzB,cAAc;IACd,aAAa;IACb,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,SAAS;IACT,iBAAiB;AACrB;;AAEA,uBAAuB;AACvB;IACI,yBAAyB;IACzB,YAAY;IACZ,kBAAkB;IAClB,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,WAAW;IACX,kBAAkB;AACtB;;AAEA,cAAc;AACd;IACI,aAAa;IACb,8BAA8B;IAC9B,oBAAoB;IACpB,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,iBAAiB;IACjB,SAAS;IACT,cAAc;AAClB;;AAEA;IACI,eAAe;IACf,YAAY;AAChB;;AAEA,iBAAiB;AACjB;IACI,gBAAgB;IAChB,UAAU;IACV,SAAS;IACT,aAAa;IACb,sBAAsB;IACtB,SAAS;AACb;;AAEA,mBAAmB;AACnB;IACI,sBAAsB;IACtB,uBAAuB;IACvB,kBAAkB;IAClB,wCAAwC;IACxC,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;IACjB,yBAAyB;IACzB,sBAAsB;AAC1B;;AAEA;EACE,aAAa;EACb,MAAM;EACN,QAAQ;EACR,YAAY;EACZ,eAAe;EACf,WAAW;EACX,YAAY;EACZ,gBAAgB;EAChB,kBAAkB;AACpB;;;AAGA;IACI,yBAAyB;AAC7B;;AAEA;IACI,aAAa;AACjB;;AAEA,gCAAgC;AAChC;IACI,WAAW;IACX,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,UAAU;IACV,YAAY;IACZ,yBAAyB;IACzB,WAAW;IACX,YAAY;IACZ,iBAAiB;;AAErB;AACA;IACI,yBAAyB;AAC7B;;AAEA;IACI,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,UAAU;IACV,YAAY;IACZ,yBAAyB;IACzB,WAAW;IACX,YAAY;IACZ,eAAe;AACnB;;AAEA;AACA,yBAAyB;AACzB;;AAEA,0CAA0C;AAC1C;IACI,gBAAgB;IAChB,YAAY;AAChB;;AAEA,sBAAsB;AACtB;IACI,cAAc;IACd,iBAAiB;IACjB,kBAAkB;IAClB,eAAe;IACf,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,cAAc;AAClB;;AAEA,4BAA4B;AAC5B;IACI,aAAa;EACf;;EAEA;IACE,YAAY;IACZ,gBAAgB;EAClB;;EAEA,mCAAmC;EACnC;IACE,gBAAgB;IAChB,8BAA8B;EAChC;;EAEA;IACE,aAAa;EACf;;EAEA;IACE,YAAY;IACZ,yBAAyB;IACzB,uBAAuB;IACvB,aAAa;IACb,sBAAsB;IACtB,kCAAkC;EACpC","sourcesContent":["* {\n    box-sizing: border-box;\n    padding: 0;\n    margin: 0;\n}\n\n:disabled {\n    background-color: dimgrey;\n    color: linen;\n    opacity: 1;\n}\n\n/* Общие стили */\nbody {\n    font-family: Arial, sans-serif;\n    background-color: #b2ebf2;\n    color: #837e7e;\n    padding: 20px;\n    display: flex;\n    justify-content: center;\n    align-items: flex-start;\n    gap: 20px;\n    min-height: 100vh;\n}\n\n/* Контейнеры списков */\n.container {\n    background-color: #ebecf0;\n    width: 300px;\n    border-radius: 3px;\n    padding: 10px;\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n    color: #333;\n    border-radius: 6px;\n}\n\n/* Заголовки */\n.wrapper__title {\n    display: flex;\n    justify-content: space-between;\n    align-items: stretch;\n    margin-bottom: 10px;\n}\n\n.title-list {\n    font-size: 20px;\n    font-weight: bold;\n    margin: 0;\n    color: #898989;\n}\n\n.toggle__option {\n    cursor: pointer;\n    height: 21px;\n}\n\n/* Список задач */\n.task__list {\n    list-style: none;\n    padding: 0;\n    margin: 0;\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n}\n\n/* Элементы задач */\n.task__item {\n    background-color: #fff;\n    padding: 25px 10px 10px;\n    border-radius: 6px;\n    box-shadow: 0 1px 2px rgba(0, 0, 0, 0.1);\n    color: #333;\n    cursor: grab;\n    position: relative;\n    user-select: none;\n    -webkit-user-select: none;\n    -moz-user-select: none;\n}\n\n.delete__task-button {\n  display: none;\n  top: 0;\n  right: 0;\n  padding: 5px;\n  cursor: pointer;\n  width: 25px;\n  height: 25px;\n  user-select: all;\n  position: absolute;\n}\n\n\n.delete__task-button:hover {\n    background-color: #f9f9fa;\n}\n\n.form {\n    display: none;\n}\n\n/* Форма создания новой задачи */\n.text__new-task {\n    width: 100%;\n    height: 4rem;\n    resize: none;\n    border: none;\n    padding: 5px;\n}\n\n.text__new-task:focus {\n    outline: none;\n}\n\n.container__button {\n    display: flex;\n    justify-content: space-between;\n}\n\n.button__add {\n    width: 70%;\n    border: none;\n    background-color: #42a5f5;\n    color: #fff;\n    padding: 5px;\n    margin-right: 3px;\n\n}\n.button__add:disabled {\n    background-color: #cbcbcb;\n}\n\n.button__add:hover:enabled {\n    background-color: #1e88e5;\n    cursor: pointer;\n}\n\n.button__add:focus {\n    outline: none;\n}\n\n.button__cancel {\n    width: 30%;\n    border: none;\n    background-color: #e57373;\n    color: #fff;\n    padding: 5px;\n    cursor: pointer;\n}\n\n.button__cancel:hover {\nbackground-color: #f44336;\n}\n\n/* Стиль для карточек при перетаскивании */\n.task__item:active {\n    cursor: grabbing;\n    opacity: 0.8;\n}\n\n/* Кнопка добавления */\n.btn__add-card {\n    color: #837e7e;\n    padding: 8px 10px;\n    border-radius: 3px;\n    cursor: pointer;\n    text-align: start;\n    font-size: 14px;\n}\n\n.btn__add-card:hover {\n    color: #0052cc;\n}\n\n/* Перетаскиваемый элемент */\n.task__item.hidden {\n    display: none;\n  }\n\n  .task__item.dragging {\n    opacity: 0.5;\n    cursor: grabbing;\n  }\n\n  /* Эффект при наведении на список */\n  .task__list {\n    min-height: 50px;\n    border: 2px dashed transparent;\n  }\n\n  .hidden {\n    display: none;\n  }\n\n  .placeholder {\n    height: 50px;\n    background-color: #f8f8f8;\n    border: 1px dashed #ccc;\n    margin: 5px 0;\n    box-sizing: border-box;\n    transition: border-color 0.3s ease;\n  }\n"],"sourceRoot":""}]);
// Exports
...
function removeItem() {
  ...
  removeTask.forEach(function (element) {
...
function removeTaskColumn() {
  var removeAllTaskColumn = document.querySelectorAll(".toggle__option");
  removeAllTaskColumn.forEach(function (element) {
    element.addEventListener("click", function (e) {
      var allTask = e.target.parentNode.parentNode.querySelectorAll(".task__item");
...
function onDragOver(e) {
  e.preventDefault();
  var target = e.target;
  var taskList = target.closest(".task__list");
  if (taskList && draggedElement) {
    var taskItems = taskList.querySelectorAll(".task__item");
    if (taskItems.length === 0) {
      if (!taskList.contains(placeholder)) {
        placeholder = placeholder || createPlaceholder();
        taskList.appendChild(placeholder);
      }
    } else if (target && target.classList.contains("task__item") && target !== draggedElement) {
...
function onDrop(e) {
  e.preventDefault();
  var targetList = e.target.closest(".task__list");
...
function saveResult() {
  ...
  taskLists.forEach(function (item) {
    if (item.closest(".todo__container")) {
      var listElements = item.querySelectorAll(".task__item");
      listElements.forEach(function (element) {
        store.TODO.push(element.textContent);
      });
    } else if (item.closest(".inProgress__container")) {
      var _listElements = item.querySelectorAll(".task__item");
      _listElements.forEach(function (element) {
        store.PROGRESS.push(element.textContent);
      });
    } else {
      var _listElements2 = item.querySelectorAll(".task__item");
      _listElements2.forEach(function (element) {
...
function initLists(taskList) {
  if (localStorage) {
    ...
    var _taskList = _slicedToArray(taskList, 3),
      todo = _taskList[0],
      progress = _taskList[1],
      done = _taskList[2];
    if (store.TODO.length > 0) {
      store.TODO.forEach(function (element) {
        addTask(element, todo);
      });
    }
    if (store.PROGRESS.length > 0) {
      store.PROGRESS.forEach(function (element) {
        addTask(element, progress);
      });
    }
    if (store.DONE.length > 0) {
      store.DONE.forEach(function (element) {
